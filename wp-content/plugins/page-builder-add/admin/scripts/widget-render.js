...
function rowColumnSingleRender(thisColumnModelData, rowID ,this_column, rowColumns){
        ...
        $('#'+colID).attr( 'style', thisColumnStylesInline );
        $('#'+colID+'> #columnResponsiveScripts' ).html(currColResponsiveScriptsTrigger);
        $('#'+colID+'> #columnStyleTag' ).html(thisColHoverStyleTag);
...
function rowOptionsRender(rowID,rowCID,rowColumns,rowHeightUnit,rowData, rowHeightTablet,rowHeightUnitTablet,rowHeightMobile,rowHeightUnitMobile){
  ...
  var custom_JS = rowData['customJS'];
      ...
      if (typeof(rowData['rowCustomClass']) !== 'undefined' ) {
        $('li[data-model-cid="'+rowCID+'"] section').attr('class','row'+rowData['rowCustomClass']);
      }
      ...
      $('#'+rowID).attr('style','height:auto; overflow:hidden; '+rowBackgroundOptions+' '+rowBackgroundParallax+' '+currRowMargins+' '+currRowPadding +custom_styling );

      $('#'+rowID + ' .row-overlay').attr('style','height:100%; '+rowOverlayBackgroundOptions+' top:0; left: 0; width: 100%; position:absolute;');
      $('#'+rowID + ' #thisRowScripts').html( currentRowResponsiveTriggerScripts + thisRowHoverStyleTag );
